...
3. run main.py file
4. if you want to use the bot as admin send the password after /starting it
5. Now bot works in 2 languages. To update languages open language.json file do these if you don't skip
